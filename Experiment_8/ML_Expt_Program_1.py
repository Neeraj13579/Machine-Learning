...
master = Tk()
master.title("Neeraj Kumar Customer 211P065 Segmentation using Machine Learning")
Label(master, text=" Neeraj Kumar 211P065 Customer Segmentation using Machine Learning", bg="Yellow", fg="black").grid(row=0, columnspan=2)
